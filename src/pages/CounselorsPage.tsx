    ...
    return (
      <div className={`min-h-screen bg-white ${location.pathname.startsWith("/admin") ? "pt-6" : "pt-32"}`}>
        <div className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-[#800020] mb-8">Counselors</h1>
    ...
    <div className={`min-h-screen bg-white ${location.pathname.startsWith("/admin") ? "pt-6" : "pt-32"}`}>
      <div className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-16">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-4xl font-bold text-[#800020]">Counselors</h1>
              </div>
        ...
        {filteredCounselors.length === 0 ? (
          ...
          >
            <h2 className="text-xl font-semibold text-gray-700 mb-2">No counselors found</h2>
