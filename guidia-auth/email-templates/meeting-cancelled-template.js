const getMeetingCancelledTemplate = (recipientEmail, cancellerName, meetingDate, startTime, endTime, meetingTitle) => {
  ...
  return {
    ...
    to: recipientEmail,
    subject: `Meeting Cancelled by ${cancellerName}`,
    text: `${cancellerName} has cancelled the meeting scheduled for ${formattedDate} at ${formattedTime}. Title: ${meetingTitle}. Please log in to your account to view the meeting details or schedule a new meeting.`,
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table width="100%" style="max-width: 640px; background-color: #ffffff; border-radius: 12px; border-collapse: collapse;" role="presentation">
          <tr>
            <td style="padding: 48px;" class="content">
              ...
              <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 32px; color: #000000; margin: 0 0 24px; text-align: center;">Meeting Cancelled</h1>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px; font-weight: 600;">Hello!</p>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px;">${cancellerName} has cancelled the meeting scheduled for ${formattedDate} at ${formattedTime}. Please review the details below:</p>
              ...
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px;">Please log in to your account to view your meetings or schedule a new meeting.</p>
...
module.exports = getMeetingCancelledTemplate;
