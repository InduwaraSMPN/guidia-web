                    ...
                    <tbody>
                      <tr>
                        <td align="center" style="padding:0;margin:0;border:none;border-spacing:0px;border-collapse:collapse;vertical-align:top;padding-top: 64px;">
                          ...
                          <h2 style="font-family:'Montserrat';color:#000000;font-weight:600;text-align: center; padding-top: 32px; padding-bottom: 3px;">Meeting Cancelled</h2>
                              ...
                              <tr>
                                <td style="padding: 32px;">
                                  ...
                                  <p style="margin:0;padding:0;padding-bottom:20px;line-height:1.6;font-family:'Open Sans';color:#000000;text-align: left;">
                                    ${cancellerName} has cancelled the meeting scheduled for ${formattedDate} at ${formattedTime}.
                                  </p>
                                  ...
                                  <p style="margin:0;padding:0;padding-bottom:20px;line-height:1.6;font-family:'Open Sans';color:#000000;text-align: left;">
                                    Please log in to your account to view the meeting details or schedule a new meeting.
                                  </p>
