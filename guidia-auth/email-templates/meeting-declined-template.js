const getMeetingDeclinedTemplate = (recipientEmail, declinerName, meetingDate, startTime, endTime, meetingTitle, declineReason) => {
  ...
  return {
    ...
    to: recipientEmail,
    subject: `Meeting Declined by ${declinerName}`,
    text: `${declinerName} has declined your meeting request for ${formattedDate} at ${formattedTime}. Title: ${meetingTitle}. ${declineReason ? `Reason: ${declineReason}` : ''}. Please log in to your account to view the meeting details or request a new meeting.`,
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table width="100%" style="max-width: 640px; background-color: #ffffff; border-radius: 12px; border-collapse: collapse;" role="presentation">
          <tr>
            <td style="padding: 48px;" class="content">
              ...
              <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 32px; color: #000000; margin: 0 0 24px; text-align: center;">Meeting Declined</h1>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px; font-weight: 600;">Hello!</p>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px;">${declinerName} has declined your meeting request. Please review the details below:</p>
              ...
              <table width="100%" style="margin-bottom: 32px; border-collapse: collapse;" class="details-table" role="presentation">
                ...
                ${declineReason ? `
                <tr style="background-color: #f9fafb;">
                  <td style="padding: 16px; width: 30%; font-family: 'Open Sans', sans-serif; font-size: 15px; font-weight: 600; color: #374151; vertical-align: top; border-bottom: 1px solid #e5e7eb;">Reason:</td>
                  <td style="padding: 16px; font-family: 'Open Sans', sans-serif; font-size: 15px; color: #1f2937; border-bottom: 1px solid #e5e7eb;">${declineReason}</td>
                </tr>
                ` : ''}
              </table>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px;">Please log in to your account to view your meetings or request a new meeting.</p>
              <table width="100%" style="border-collapse: collapse;" role="presentation">
                <tr>
                  <td align="center" style="padding: 32px 0 0;">
                    <a href="${process.env.FRONTEND_URL || 'https://example.com'}/meetings/my-meetings" target="_blank" style="background-color: #800020; color: white; padding: 16px 32px; text-decoration: none; border-radius: 6px; font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 16px; display: inline-block;">View Meetings</a>
                  </td>
                </tr>
              </table>
            </td>
...
module.exports = getMeetingDeclinedTemplate;
