                    ...
                    <tbody>
                      <tr>
                        <td align="center" style="padding:0;margin:0;border:none;border-spacing:0px;border-collapse:collapse;vertical-align:top;padding-top: 64px;">
                          ...
                          <h2 style="font-family:'Montserrat';color:#000000;font-weight:600;text-align: center; padding-top: 32px; padding-bottom: 3px;">Meeting Declined</h2>
                              ...
                              <tr>
                                <td style="padding: 32px;">
                                  ...
                                  <p style="margin:0;padding:0;padding-bottom:20px;line-height:1.6;font-family:'Open Sans';color:#000000;text-align: left;">
                                    ${declinerName} has declined your meeting request.
                                  </p>
                                  <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
                                    ...
                                    ${declineReason ? `
                                    <tr>
                                      <td style="padding:10px; border-bottom:1px solid #eee; font-family:'Open Sans';"><strong>Reason:</strong></td>
                                      <td style="padding:10px; border-bottom:1px solid #eee; font-family:'Open Sans';">${declineReason}</td>
                                    </tr>
                                    ` : ''}
                                  </table>
                                  <p style="margin:0;padding:0;padding-bottom:20px;line-height:1.6;font-family:'Open Sans';color:#000000;text-align: left;">
                                    Please log in to your account to view the meeting details or request a new meeting.
                                  </p>
                                  <div style="text-align:center; margin-top:30px;">
                                    <a href="${process.env.FRONTEND_URL || 'http://localhost:1030'}/meetings/my-meetings" style="background-color:#800020; color:white; padding:12px 24px; text-decoration:none; border-radius:4px; font-family:'Montserrat'; font-weight:600;">View Meetings</a>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
