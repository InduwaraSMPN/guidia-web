              ...
              <tbody>
                <tr>
                  <td align="center">
                    ...
                    <h2 style="font-family:'Montserrat';color:#000000;font-weight:600;text-align:center;padding-top:32px;padding-bottom:3px;">Registration Approved!</h2>
                    <div style="padding: 32px;">
                      ...
                      <p style="margin:0;padding:0;padding-bottom:20px;line-height:1.6;font-family:'Open Sans';color:#000000;text-align:left;">
                        Great news! Your registration request has been approved. You can now access all features of our platform.
                      </p>
                      <div style="text-align:center;padding:20px 0;">
                        <a href="${loginUrl}" style="background-color:#800020;color:white;padding:12px 24px;text-decoration:none;border-radius:4px;font-family:'Montserrat';font-weight:600;">
