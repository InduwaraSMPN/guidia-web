        ...
        <table width="100%" style="max-width: 640px; background-color: #ffffff; border-radius: 12px; border-collapse: collapse;" role="presentation">
          <tr>
            <td style="padding: 48px;" class="content">
              ...
              <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 32px; color: #000000; margin: 0 0 24px; text-align: center;">Registration Status Update</h1>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 16px; font-weight: 600;">Hello,</p>
              <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0 0 24px;">We regret to inform you that your registration request has been declined.</p>

              <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; margin: 0 0 32px; border: 1px solid #e5e7eb;">
                <p style="font-family: 'Open Sans', sans-serif; font-size: 15px; color: #6b7280; margin: 0 0 8px;">
                  Reason for decline:
                </p>
                <p style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #1f2937; margin: 0; font-weight: 600;">
                  ${reason}
                </p>
              </div>
            </td>
